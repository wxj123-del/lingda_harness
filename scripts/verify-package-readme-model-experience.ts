...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/media/generation-core': { kind: 'none', reason: 'Shared media configuration and HTTP helpers register no tools, prompts, or session events.' },
  'packages/client/ui-step-insight': { kind: 'none', reason: 'The browser reads existing Session events and registers no model-facing context or tools.' },
