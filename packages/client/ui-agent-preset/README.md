...
The shipped `diaosi` preset appears as Budget mode in English and 屌丝模式 in Chinese. Select it from the new-session picker or set it as the default in this section; its [preset documentation](../../preset/agent-presets/README.md#use-this-package) describes the tool and context limits.
