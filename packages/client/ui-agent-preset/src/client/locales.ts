...
export type AgentPresetSettingsKey =
  ...
  | 'presetDiaosiName' | 'presetDiaosiDescription'
...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  presetDiaosiName: 'Budget mode',
  presetDiaosiDescription: 'Save tokens with file editing, shell, search and skills, bounded tool output, and earlier history compaction.',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  presetDiaosiName: '屌丝模式',
  presetDiaosiDescription: '节省 Token 的日常 Agent，保留文件编辑、Shell、搜索和 Skill，限制长输出并提前压缩历史。',
