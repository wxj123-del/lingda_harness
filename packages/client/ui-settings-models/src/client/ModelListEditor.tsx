...
/** Whether a configured or discovered model explicitly accepts image input. */
          ...
          {expanded.has(index)
            ? (
              <div className={styles['modelAdvanced']}>
                ...
                <label className={styles['modelFieldCheckbox']}>
                  <input
                    type="checkbox"
                    aria-label={`${t('modelInputImages')} ${index + 1}`}
                  ...
                  />
                  <span className={styles['modelFieldLabel']}>{t('modelInputImages')}</span>
                </label>
              </div>
            )
            : null}
