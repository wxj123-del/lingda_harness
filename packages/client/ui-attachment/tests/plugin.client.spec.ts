...
import { GeneratedImageTool } from '../src/client/GeneratedImageTool.tsx'
...
describe('attachment plugin', () => {
  ...
  it('registers all entries and removes them with the plugin fiber', async () => {
    ...
    expect(ctx.slots.entries('tool.call.toolview')).toMatchObject([{ component: GeneratedImageTool }])
