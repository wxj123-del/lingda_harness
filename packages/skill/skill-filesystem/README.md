...
| 500 | `user-agents` | `<agentsHome>/skills`, controlled by `includeAgentsHome` |
...
| `includeAgentsHome` | `true` | Include the shared agent configuration root `<agentsHome>/skills`; disabling it keeps project, `dshHome`, and custom roots |
