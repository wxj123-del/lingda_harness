...
describe('minimal agent preset', () => {
  ...
  it('sends the selected model identity and shell schema, then executes the persistent shell', async () => {
    ...
    expect({
      ...
      [Command finished with exit code 0]",
        "goalCommand": false,
        "prompt": "You are a helpful software engineer assistant running on the deepseek-v4-flash model from the deepseek-official provider.",
        "tools": [
          "bash",
        ],
      }
